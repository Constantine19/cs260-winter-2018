...
# 		I. Time measurements of the following 5 operations on lists: 
#			1) iterated insertion - in front
#			2) iterated insertion - at the back
#			3) traversal
#			4) iterated deletion - in front
#			5) iterated deletion - at the back
# 
# 		Each of the procedures is run on 3 types of lists: 
#			1) a selected list type library data structure
#			2) an implementation of the list ADT with arrays
#			3) an implementation of the list ADT with pointers
#			
#		II. Time measurements of the following 2 operations on stacks:
#			1) iterated insertion - PUSH operation
#			2) iterated deletion - POP operation
#			
#		Each of your procedures is run on 3 types of stacks: 
#			1) a selected stack type library data structure
#			2) an implementation of the stack ADT with arrays
#			3) an implementation of the stack ADT with pointers
