...
# Date: 03/06/2018
#
# Description: 	This program implements trees, leftmost-child right-sibling
#				implementation with the following operations: PARENT, LEFTMOST_CHILD,
# 				RIGHT_SIBLING, LABEL, CREATEi (i=0,1,2,3), ROOT, MAKENULL
